...
<body>
	<div class="wrap" style="height:100vh;">
		<div class="row d-flex align-items-center">
			<div class="card-header" style="border-bottom: none;">
  			<h3 class="card-title ml-2 mt-2" style="font-size: 25px; font-weight: bold;">평가 수정</h3>
  			</div>
      ...
      <div class="col-2" style="margin-left:73px; margin-right:50px;">
        <button type="button" class="btn btn-info" onclick="regist_go();"
          ...
          <span style="color:#ffffff; font-size:20px;">수정</span>
        </button>
      </div>
  		</div>
  		<form role="form" method="post" action="${pageContext.request.contextPath}/roadmap/evaluation/modify" name="modifyEvaluation">	
  		...
  		<label>
  			...
  			<div class="d-flex" style="border:1px solid #000000; border-top:3px solid #2ec4b6; width:625px; margin-left:40px; align-items:center;border-collapse: collapse;">
  				<div style="width:100%;">
  				<textarea class="form-control" name="eval_content" id="eval_content" rows="5"  placeholder="1000자 내외로 작성하세요." style="resize: none;">${evaluation.eval_content }</textarea>
  				</div>
  			</div>
  ...
  <tr>
    <td style="text-align:center; background-color:#f0f0f0; height: 50px;">총점(기존 점수 : ${eval_score } )</td>
  ...
  function calculateTotal() {
	...
	window.onload = calculateTotal;
	 ...
	 function regist_go() {
	      let form = document.forms["modifyEvaluation"];
